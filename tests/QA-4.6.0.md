...
- `bash scripts/validate_repo.sh` mit gebündeltem Python: bestanden. 77 Unit-/Regressionstests (15 Plugin-Werkzeuge, 10 Vertragsartefakte, 6 Verjährung, 25 Dialog-/Ablaufregeln, 21 Promptlayout/Quellenstruktur).
...
Werkstatt: 43 Seiten. Mini: 6 Seiten. Letter, Arial 11 pt, Ränder 2,54 cm. Der Export übernimmt den vollständigen lesbaren Prompt ohne YAML-Metadatenblock und prüft die geordnete Textfolge.

Der Hauptagent hat sämtliche finalen 43 beziehungsweise sechs PNG-Seiten einzeln visuell geprüft: lesbare Absätze und Tabellen, vollständige Texte, keine Überlappungen oder abgeschnittenen Quellen. Die [Layoutakte](prompt-layout-4.6.0.json) enthält genaue Quell- und Dateiprüfsummen. Andere Word-Versionen und ein unmittelbarer Markdown-Import können anders umbrechen.
