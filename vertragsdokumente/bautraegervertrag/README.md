...
Dieses Verzeichnis enthält den Vertrag in den deutschen Gesamtfassungen, einen Bautenstandsbericht, die darauf gestützte Zahlungsanforderung, ein Akten-ZIP mit vier getrennten Einzel-PDFs und die zweispaltige Deutsch/English-Lesefassung des Vertrags.
...
| Bautenstandsbericht Markdown | [öffnen](bautraegervertrag-bautenstandsbericht.md) | [ansehen](https://klotzkette.github.io/bautraegervertragspruefer-skill/vertragsdokumente/bautraegervertrag/bautraegervertrag-bautenstandsbericht.md) | [laden](https://github.com/Klotzkette/bautraegervertragspruefer-skill/releases/latest/download/bautraegervertrag-bautenstandsbericht.md) |
| Bautenstandsbericht PDF | [herunterladen](bautraegervertrag-bautenstandsbericht.pdf) | [ansehen](https://klotzkette.github.io/bautraegervertragspruefer-skill/vertragsdokumente/bautraegervertrag/bautraegervertrag-bautenstandsbericht.pdf) | [laden](https://github.com/Klotzkette/bautraegervertragspruefer-skill/releases/latest/download/bautraegervertrag-bautenstandsbericht.pdf) |
| Zahlungsanforderung Markdown | [öffnen](bautraegervertrag-zahlungsanforderung.md) | [ansehen](https://klotzkette.github.io/bautraegervertragspruefer-skill/vertragsdokumente/bautraegervertrag/bautraegervertrag-zahlungsanforderung.md) | [laden](https://github.com/Klotzkette/bautraegervertragspruefer-skill/releases/latest/download/bautraegervertrag-zahlungsanforderung.md) |
| Zahlungsanforderung PDF | [herunterladen](bautraegervertrag-zahlungsanforderung.pdf) | [ansehen](https://klotzkette.github.io/bautraegervertragspruefer-skill/vertragsdokumente/bautraegervertrag/bautraegervertrag-zahlungsanforderung.pdf) | [laden](https://github.com/Klotzkette/bautraegervertragspruefer-skill/releases/latest/download/bautraegervertrag-zahlungsanforderung.pdf) |
...
Nach Änderungen am Vertrag, am [`Bautenstandsbericht`](bautraegervertrag-bautenstandsbericht.md) oder an der [`Zahlungsanforderung`](bautraegervertrag-zahlungsanforderung.md) erzeugt [`build.sh`](build.sh) Word-Fassung, Gesamt-PDF, beide Akten-PDFs und das Vier-Dokumente-ZIP:

```bash
./build.sh
```

Voraussetzungen: `pandoc` und `weasyprint`. Layout und Seitenumbrüche steuern [`build/style.css`](build/style.css), das gemeinsame [`case-style.css`](../case-style.css) und [`build/pagebreak.lua`](build/pagebreak.lua).
