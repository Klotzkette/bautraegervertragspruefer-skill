...
| Schlussrate: Abnahmereife als KG-Korrektiv | KG Berlin, Urteil vom 27.05.2025 - 21 U 44/22, amtlich: https://gesetze.berlin.de/bsbe/document/NJRE001609941 | Der Begriff der `vollständigen Fertigstellung` im Sinn der MaBV kann mit Abnahmereife gleichgesetzt werden; bei abnahmereifem Werk führen einzelne Protokollmängel dann eher zu Mängeleinrede/Zurückbehaltung als automatisch zu fehlender Fälligkeit. | Als Gegenseiten- und Differenzierungsanker nutzen: zuerst Vertragswortlaut, Protokollbindung und Mangelgewicht prüfen; BGH VII ZR 88/25 bleibt für vertraglich gebundene Restarbeiten vorrangig. |
...
| Übergabeprotokolle, Nutzung und Kaufpreiszahlung als keine sichere GE-Abnahme | OLG München, Beschluss vom 08.01.2024 - 9 U 1803/23 Bau e, amtlich: https://www.gesetze-bayern.de/Content/Document/Y-300-Z-BECKRS-B-2024-N-49081?hl=true | Ist im Vertrag eine Abnahme des Gemeinschaftseigentums durch einen Dritten vorgesehen, begründen einzelne Übergabeprotokolle, Kaufpreiszahlung, Nutzung oder längere Rügelosigkeit ohne klare Erklärung und Erklärungsbewusstsein regelmäßig keine Abnahme des Gemeinschaftseigentums. Die Darlegungs- und Beweislast für die Abnahme trägt, wer sich darauf beruft. | Gegen Einwände `Schlüsselübergabe`, `voll bezahlt`, `jahrelang genutzt`, `Protokoll unterschrieben`; Vertragskontext und Abnahmewillen konkret prüfen. |
...
**KG-/OLG-Korrektiv für Schlussrate, Bezugsfertigkeit und Abnahme.** Nicht mit Automatismen arbeiten. Bei Schlussrate und Bezugsfertigkeitsrate zuerst die konkrete Fälligkeitsklausel auslegen, dann Abnahmereife, Mangelgewicht, Protokollbindung und Zurückbehaltungsrechte trennen. BGH VII ZR 88/25 trägt stark, wenn der Vertrag die letzte Rate an die Beseitigung protokollierter Mängel/Restarbeiten bindet. KG 21 U 44/22 ist der Gegenanker für Fälle, in denen abnahmereife Leistung vorliegt und einzelne Mängel nur Mängeleinrede/Einbehalt auslösen. KG 21 U 156/24 verschärft zugleich die Bezugsfertigkeitsrate: auch optische Abweichungen können wesentlich sein, wenn sie ein vertraglich prägendes Gestaltungselement betreffen. Bei Abnahme des Gemeinschaftseigentums dürfen Übergabeprotokolle, Nutzung, Kaufpreiszahlung und Rügelosigkeit nicht isoliert als Abnahme gewertet werden; OLG München 9 U 1803/23 Bau e verlangt Vertragskontext, Erklärungsbewusstsein und Abnahmewillen.
