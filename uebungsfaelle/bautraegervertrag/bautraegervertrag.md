...
Die Bemusterung erfolgt im vom Verkäufer benannten Bemusterungszentrum Berlin-Schöneberg. Im Kaufpreis enthalten sind drei Beratungsstunden. Darüber hinausgehender Beratungsaufwand des Verkäufers ist durch den Käufer mit einem Stundensatz von 180,00 EUR netto zu vergüten.

Die Bemusterung hat spätestens vier Wochen nach Aufforderung des Verkäufers stattzufinden. Reagiert der Käufer auf die Aufforderung nicht oder nicht rechtzeitig, wählt der Verkäufer nach billigem Ermessen aus der Standardausstattung aus; ein Anspruch auf nachträgliche Änderung besteht nicht.
...
Behinderungen bei der Herstellung des Bauvorhabens aus Umständen, die vom Verkäufer nicht zu vertreten sind, z. B. höhere Gewalt, Pandemielagen, Lieferengpässe, Streik, Aussperrung, Witterungsverhältnisse einschließlich Hitze- und Kälteperioden, Wechselkursbewegungen bei Baustoffen, Personalengpässe oder sonstige für den Verkäufer unabwendbare oder nicht zumutbare Umstände, verlängern die jeweils betroffene Herstellungsfrist um die Dauer der Behinderung zuzüglich eines angemessenen Zuschlags für die Wiederaufnahme.
...
**7.1** Sämtliche Kosten der Erschließung sowie der erstmaligen Anschlüsse des Kaufgegenstandes an Ver- und Entsorgungsanlagen einschließlich Anschlussgebühren, Herstellungsbeiträge und Abgaben nach den entsprechenden Verordnungen des Landes Brandenburg trägt der Käufer anteilig nach seinem Miteigentumsanteil.
...
**2.1** Der Gründung liegen orientierende Baugrunderkundungen zugrunde. Art und Tiefe der Gründung (Flach- oder Tiefgründung, Bodenaustausch, Bodenverbesserung) werden im Zuge der Ausführungsplanung durch den Tragwerksplaner festgelegt.

**2.2** Maßnahmen der Wasserhaltung, des Baugrubenverbaus, der Grundwasserabsenkung sowie etwaige Anpassungen infolge tatsächlicher Baugrund-, Grundwasser-, Altlasten- oder Kampfmittelbefunde gehören zur bauseitigen Herstellung, begründen jedoch keine über diese Baubeschreibung hinausgehende Beschaffenheit. Die Abdichtung der erdberührten Bauteile erfolgt nach den einschlägigen technischen Regelwerken in einer für die vorgesehene Nutzung geeigneten Ausführung.
...
**3.2** Nichttragende Trennwände innerhalb der Wohnung werden in Trockenbau- oder Mauerwerksausführung erstellt. Die genaue Ausführung wählt der Verkäufer.
...
**4.1** Die Außenwände erhalten ein Wärmedämmverbundsystem oder eine gleichwertige Dämmkonstruktion mit Putzoberfläche bzw. teilweiser Vorhangfassade nach Wahl des Verkäufers. Farbgebung und Materialität der Fassade legt der Verkäufer im Rahmen des Gestaltungskonzepts fest.
...
**6.3** Die Wohnungseingangstür wird als Tür mit üblichem Einbruch- und Schallschutz in handelsüblicher Qualität ausgeführt.
...
**9.1** Die Innentüren werden als Zimmertüren in handelsüblicher Ausführung mit Standardbeschlag eingebaut. Oberfläche, Farbe und Drückergarnitur richten sich nach dem Standardsortiment des Verkäufers.
...
**11.1** Die Beheizung und Warmwasserbereitung erfolgt über eine zentrale Anlage nach Wahl des Verkäufers (Fernwärme, Wärmepumpe, Brennwerttechnik oder eine Kombination hiervon). Die Wohnräume erhalten Heizflächen (Fußbodenheizung und/oder Heizkörper) in einer für die vorgesehene Nutzung geeigneten Auslegung.
...
**13.1** Die Elektroinstallation wird nach den einschlägigen technischen Regeln in einer für Wohnnutzung üblichen Ausstattungsdichte ausgeführt. Anzahl und Position von Steckdosen, Schaltern und Anschlüssen ergeben sich aus den Ausführungsplänen.

**13.2** Die Wohnung erhält einen Multimedia-/Datenanschluss in handelsüblicher Ausführung. Eine bestimmte Bandbreite oder ein bestimmter Anbieter wird nicht geschuldet.
...
**14.1** Haus 4 erhält einen Personenaufzug in handelsüblicher Ausführung, der die Wohngeschosse und die Tiefgarage erschließt. Fabrikat, Förderhöhe und Kabinenausstattung wählt der Verkäufer.

# 15 Tiefgarage

**15.1** Die Tiefgarage wird in Stahlbeton ausgeführt und maschinell be- und entlüftet. Bodenbeschichtung, Markierung und technische Ausstattung erfolgen in für Tiefgaragen üblicher Qualität.

**15.2** Der dem Käufer zugeordnete Stellplatz TG-127 wird als Standard-Stellplatz hergestellt. Eine bestimmte Mindestbreite oder Mindesthöhe über das bauordnungsrechtlich Erforderliche hinaus wird nicht geschuldet.
...
**18.1** Die Außenanlagen (Wege, Zufahrten, Pflanzflächen, Spielplatz, Quartiersplatz, Müllstandorte) werden nach dem Freiflächenkonzept hergestellt. Art, Umfang und Zeitpunkt der Fertigstellung richten sich nach dem Bauablauf des Gesamtquartiers und können nach dem Übergabetag der Wohnung liegen.

**18.2** Die Terrasse T-4.27 wird mit einem Bodenbelag in für Außenflächen üblicher Qualität hergestellt.
...
**20.1** Der Käufer wählt im Rahmen der Bemusterung im vom Verkäufer benannten Bemusterungszentrum aus dem jeweils gültigen Standardsortiment. Drei Beratungsstunden sind im Kaufpreis enthalten; darüber hinausgehender Aufwand wird mit 180,00 EUR netto je angefangener Stunde vergütet.

**20.2** Die Bemusterung hat innerhalb von vier Wochen nach Aufforderung stattzufinden. Reagiert der Käufer nicht rechtzeitig, wählt der Verkäufer aus der Standardausstattung. Spätere Änderungen sind nur möglich, soweit der Baufortschritt es zulässt, und gesondert zu vergüten.

**20.3** Sonderwünsche außerhalb des Standardsortiments sind vor Beginn der betroffenen Bauleistung vollständig und im Voraus zu zahlen.
