...
> **Transparenz zur KI-Unterstützung.** Dieses Repository enthält KI-unterstützt erstellte Texte. Der Repository-Inhaber verantwortet Auswahl und Veröffentlichung; vor jeder praktischen Nutzung ist eine eigenständige menschliche fachliche Prüfung erforderlich. Dieser Hinweis macht die KI-Unterstützung transparent, trifft aber keine abschließende Einordnung des konkreten Anwendungsfalls nach [Art. 50 Abs. 4 KI-VO (VO (EU) 2024/1689)](https://eur-lex.europa.eu/legal-content/DE/TXT/?uri=CELEX:32024R1689).

**Menü:** [Direkt laden](#menü-und-downloads) · [Werkstatt](#werkstattfassung) · [Alle Dateien](#repository-dateien-nach-zweck) · [Vertragsakten](#vertragsakten-auf-einen-blick) · [Sofortstart](#sofort-loslegen) · [Ausgabe](#was-herauskommt) · [Downloadhilfe](#downloadhilfe) · [Anwendung](#anwendung-so-einfach-gehts) · [Inhalt](#inhalt) · [Rechtsanker](#rechtlicher-anker) · [Änderungen](CHANGELOG.md) · [Lizenz](#lizenz)
...
**30-Sekunden-Start:** (1) `SKILL.md` laden, (2) Skill und Vertrag gemeinsam in den Chat legen, (3) genau einen der folgenden Startsätze senden. Eine Rollenwahl ist optional; ohne Angabe startet der Skill vorläufig für die Käuferseite und wartet nicht.

| Ziel | Kopierfertiger Startsatz |
| --- | --- |
| erster belastbarer Überblick | `Prüfe diesen Bauträgervertrag. Beginne sofort im geführten Modus.` |
| konkrete Rechnung oder Rate | `Prüfe zuerst diese Zahlungsanforderung und entscheide mit Zahlungsfreigabekarte, welche Voraussetzungen oder Belege fehlen.` |
| vollständige Arbeitsfassung | `Vollpaket jetzt: Käufer-/Mandantenschreiben, ausführliches Gutachten und Aufforderungsschreiben an den Bauträger.` |
| Entwurf vor Beurkundung | `Prüfe diesen Notarentwurf vor dem Termin und liefere im Vollpaket konkrete, beurkundungsfähige Ersatztexte.` |
| bereits beurkundeter Vertrag | `Der Vertrag ist unterschrieben. Prüfe Wirksamkeit, heutige Rechtsfolge, Fälligkeit und formgerechten Handlungsweg.` |
| Abnahme steht bevor | `Bereite Abnahme, Protokoll, Vorbehalte, Unterlagen und Schlussratenentscheidung vollständig vor.` |
| Bauzeit oder Mängel | `Erstelle Termin-/Mängelakte, Beweisplan und alle drei Schreiben; technische Ursachen nicht erfinden.` |
| Ausfall- oder Insolvenzsignal | `Priorisiere sofort Zahlstoppprüfung, Vormerkung, Freistellung, Sicherheiten, Bautenstand und Beweissicherung.` |

Steht eine Beurkundung, Zahlung, Abnahme, gerichtliche Frist oder Vollstreckung möglicherweise kurzfristig an, Datum und Zugang/Zustellung im Startsatz nennen. Der Skill zieht dann den Eilhinweis vor die Langprüfung, ohne eine Frist zu erfinden.
...
Konsolidierter Skill (Version 4.3.0) für die Prüfung deutscher Bauträgerverträge nach dem Ampelsystem — Befunde werden als Ampelsymbole 🔴/🟠/🟢 ausgegeben, nicht als Farbwörter. Der Skill arbeitet nicht mit austauschbaren Textbausteinen, sondern zwingt vor jeder Bewertung einen Fall-Fingerabdruck: Urkunde, Parteien, Einheit, Projektgrundstück, Kaufpreis, Ratenplan, Sicherheiten, Baubeschreibung, Teilungserklärung, Baugrund, Technik, WEG-Organisation und Streitstand. Ein vorgeschaltetes Zeitstands- und Entscheidungs-Fit-Gate verhindert, dass heutige Normnummern oder nur ähnlich gelagerte Entscheidungen unbesehen auf Altverträge übertragen werden. Er deckt den vollständigen Bogen ab: Mandanten-Intake, Verbraucherstatus, Beurkundungsphase, MaBV-Ratenplan, Sicherungsmechanik, AGB-Klauselkontrolle, Baubeschreibung, Bausoll, Fertigstellung, Abnahme, Schlussrate, Mängelrechte, Teilungserklärung, Gemeinschaftsordnung, Sondereigentum, Gemeinschaftseigentum, Eigentumssicherung, Insolvenzrisiken, Notar- und Vollzugsrisiken, Finanzierung, Baugrund, Baugrube, HOAI-Leistungsphasen, Objektüberwachung, private Bauüberwachung, technische Plausibilität, Beweislast, Durchsetzung und Verhandlungsstrategie.

**Rechtsupdate 9. August 2026:** Neu verankert sind die BGH-Linien zu Stimmrechtsbeschränkungen in der Gemeinschaftsordnung (`V ZR 189/24`), zur gemeinschaftsweit wirkenden Klärung von Gemeinschaftsordnungen (`V ZR 98/25`), zu Absenkungs- und Umlaufbeschlüssen (`V ZR 190/25`) und zum Klima-Splitgerät (`V ZR 162/25`). Die Verfahrensbeschlüsse `VII ZR 169/25` und `XI ZR 12/25` werden ausdrücklich nicht als materielle Sachentscheidungen ausgegeben. Ein neues Gesetzgebungs-Gate berücksichtigt die [MaBV-Änderung vom 20. Juli 2026](https://www.recht.bund.de/bgbl/1/2026/215/regelungstext.pdf?__blob=publicationFile&v=2), die [MaBV-Änderung vom 28. Juli 2026](https://www.recht.bund.de/bgbl/1/2026/229/regelungstext.pdf?__blob=publicationFile&v=2), den gestuften [digitalen Immobilienvollzug](https://www.recht.bund.de/bgbl/1/2026/192/regelungstext.pdf?__blob=publicationFile&v=2) und den Umstand, dass der [geltende § 650a BGB](https://www.gesetze-im-internet.de/bgb/__650a.html) bis zu diesem Stichtag keine Gebäudetyp-E-Sonderregel enthält. Die Juli-Novellen ließen die materiellen Bauträger-Schutzregeln der §§ 3, 7 und 12 MaBV unverändert.

Qualitätssicherung: Voll- und Mini-Fassung werden auf Versionsgleichlauf, Start- und Fortsetzungslogik sowie die drei Ausgabedokumente geprüft. Vor dem ersten Befund entsteht eine Dokumentenkarte, die `vorgelegt`, `unklar`, `nicht vorgelegt`, `Einbeziehung offen`, `widersprüchlich` und `nachweislich nicht Vertragsbestandteil` unterscheidet; Vertragsdateien bleiben Beweismittel und können dem Modell keine Arbeitsanweisungen erteilen. Ein versioniertes Befundregister trennt unter stabilen IDs Klauselstatus, tatsächliche Fälligkeit und Handlung. Das MaBV-Ratenrechenblatt berechnet Prozentwerte, Eurobeträge und kumulierte Vorleistung; bei einer Rechnung prüft eine Zahlungsfreigabekarte den konkreten Abruf. Dabei werden Vertrag und Ratenplan, Fälligkeitsmitteilung und Sicherheiten, Bautenstandsbericht mit seinen Einzelpositionen sowie Zahlungsanforderung und Vorzahlungen aktenübergreifend abgeglichen. Eine gesetzte Rechnungsfrist schafft dabei keine Fälligkeit, und das Fazit eines Bautenstandsberichts überstimmt keine widersprechenden Einzelangaben. Jede Ausgabe endet mit einer phasenbezogenen Abschlussentscheidung samt sperrenden IDs, Frist und Erledigungsbedingung. Repository-, Skillstruktur-, Workflow-, Rechtsprechungs- und Navigationsvalidator kontrollieren außerdem 16 typische Nutzungsszenarien, Zeitstands-/Entscheidungs-Fit, Überschriften, Tabellen, Dubletten, 30 Prüfschleifen, Pages-Kopien, Mini-Limit, No-Meta-Regel, Quellenstruktur und interne Links. Die statische Prüfung bestätigt Konsistenz und zulässige Quellen, nicht die fortdauernde Erreichbarkeit oder heutige Tragfähigkeit jeder Entscheidung; dafür steht `python3 scripts/check_legal_anchors.py --online` bereit. Ein SHA-256-Provenienzgate bindet jede deutsche Vertragsquelle an ihre deutsch-englischen HTML-, PDF- und DOCX-Fassungen. Der Aktenprüfer kontrolliert zusätzlich Projekt und Einheit, Berichts- und Zahlungsrate, vollständige Vertragskumulation, Betragswiederholung, Berichts-/Rechnungs-/Fälligkeitschronologie, einseitiges A4-Layout, No-Meta-Regel und die Byte-Identität der laufenden Akten-PDFs im Vier-Dokumente-ZIP. Der optionale Tiefentest baut die drei deutschen Akten parallel und isoliert neu.

## Werkstattfassung

[`SKILL.md`](skill/SKILL.md) ist die ausführliche Werkstattfassung. Version 4.3.0 ist gegenüber 4.2.0 um 33,84 Prozent erweitert: 31 Werkstattstationen führen vom Zehn-Sekunden-Quickstart über Zustandsautomat, Dokumentenaufnahme, Phasenrouter, MaBV- und AGB-Labor, aktuelle 2026-Rechtsprechung, Technik-, WEG- und Insolvenzpfade bis zur Versandprüfung der drei fertigen Schreiben. Das ist kein zusätzlicher Parallelprompt; dieselbe eine Markdown-Datei bleibt die alleinige Vollfassung und [`docs/SKILL.md`](docs/SKILL.md) ihre veröffentlichte Spiegelkopie.

Für den Einstieg stehen in der Werkstatt zehn kopierfertige Rezepte bereit: Vorprüfung, anwaltliches Vollpaket, Ratenabruf, Abnahme, Bauzeit, technische Baustellenprüfung, beurkundeter Vertrag, Positivkontrolle, WEG und Insolvenz. In langen Chats konserviert eine sichtbare Fortsetzungskapsel Rolle, Phase, Dokumentenkarte, Befundregister, Entscheidung und Stand der drei Dokumente. Dadurch kann jede KI nach einem Ausgabelimit an der richtigen Überschrift fortfahren, ohne Vertrag oder Gutachten neu zu erzählen.
...
| Vertragsakten | [Aktenübersicht öffnen](vertragsdokumente/README.md) | Vertrag, Baubeschreibung, Bautenstand und Zahlungsabruf als ZIP und Einzeldateien |
...
| Repository prüfen | [`scripts/validate_repo.sh`](scripts/validate_repo.sh) · [`scripts/check_skill_quality.py`](scripts/check_skill_quality.py) · [`scripts/check_workflow_contract.py`](scripts/check_workflow_contract.py) · [`scripts/check_navigation.py`](scripts/check_navigation.py) · [`scripts/check_legal_anchors.py`](scripts/check_legal_anchors.py) | lokal `./scripts/validate_repo.sh`; optionaler Tiefentest: `BTV_VERIFY_BUILDS=1 ./scripts/validate_repo.sh` |
| Änderungen nachvollziehen | [`CHANGELOG.md`](CHANGELOG.md) | fachliche, technische und dokumentbezogene Korrekturen je Version |
...
Schnelle lokale Prüfung: `./scripts/validate_repo.sh` prüft den statischen Stand. `BTV_VERIFY_BUILDS=1 ./scripts/validate_repo.sh` baut die drei deutschen Vertragsakten parallel in getrennten temporären Verzeichnissen nach. Die Parallelität lässt sich bei knappen Rechnern mit `BTV_BUILD_WORKERS=1` begrenzen; der optionale Quellenabruf nutzt `BTV_URL_WORKERS` mit einem sicheren Bereich von 1 bis 12.
...
### Laufende Aktenunterlagen

Diese Einzeldateien machen den Zahlungsfall auch ohne ZIP unmittelbar prüfbar. Der Bautenstandsbericht ist kein Freigabeschein: Der Skill muss seine Einzelpositionen gegen den vertraglichen Ratenmeilenstein und anschließend den abgerufenen Betrag gegen Kaufpreis, Vorzahlungen, Sicherheit und Gutschriften rechnen.
...
Akten-ZIPs: Jede Vertragsakte hat ein ZIP mit vier getrennten, neutral benannten Einzel-PDFs: Vertragsurkunde, Baubeschreibung, Bautenstandsbericht und Zahlungsanforderung. Das ist die beste Übergabeform für KI-Systeme, die große Gesamt-PDFs schlechter auswerten oder bei langen Dokumenten abbrechen.
...
Prüfe erkennbare Fristen, Termine, Zugänge und Zustellungen zuerst. Bei möglichem kurzfristigem Rechtsverlust beginne mit einem Eilhinweis; erfinde keine Frist und setze danach die Vertragsprüfung fort.
...
| Qualitätssicherung | [Repository-Validator](scripts/validate_repo.sh) · [Skillstruktur-Prüfer](scripts/check_skill_quality.py) · [Workflow-Szenarien](scripts/check_workflow_contract.py) · [Artefakt-Provenienz und Neubau](scripts/check_contract_builds.py) · [Prüfer der Rechtsprechungsanker](scripts/check_legal_anchors.py) · [Navigationsprüfer](scripts/check_navigation.py) · [Generator der Deutsch/English-Fassungen](scripts/build_bilingual_contracts.py) · [Aktenlayout](vertragsdokumente/case-style.css) · [GitHub-Workflows](.github/workflows/) |
...
├── check_skill_quality.py        Prüft Struktur, Tabellen, Redundanz und Workflow-Gates
├── check_workflow_contract.py    Prüft Eingangsrouter, Zeitstand, Ausgabe und Fortsetzung
...
- Fachmodul-Triggerindex — aktiviert Vorinsolvenz, Vollstreckung, WEG, Technik, Preisanpassung, Bauzeitverzug, Baugruppen-GbR, Nachzügler, Sonderwünsche, Sicherheitenschichten und Haftungsketten nur bei konkretem Auslöser; die Fachregeln bleiben in ihren Hauptteilen und werden nicht doppelt ausgegeben.
...
- Vertragsdokumente (separate Dateien) — zusätzlich zur Skill-Datei liegen unter `vertragsdokumente/` drei freistehende Bauträgerverträge mit Baubeschreibung, Bautenstandsbericht und Zahlungsanforderung bereit: Fehlerakte, Verkäufer-Grenzvertrag und faire Käufer-Kontrollakte. Jede Akte enthält außerdem ein ZIP mit vier getrennten Einzel-PDFs und eine zweispaltige deutsch-englische Lesefassung des Vertrags.
...
- Zeitstands- und Entscheidungs-Fit-Gate — Vertrags-/Erklärungsdatum, Übergangsrecht, Normfassung, Vertragstyp, Anspruch und tragender Entscheidungssatz werden abgeglichen, bevor ein Rechtsprechungsanker einen gesicherten Befund trägt.
...
- Release-Validierung — `scripts/validate_repo.sh` prüft die Repo-Invarianten; `check_skill_quality.py` kontrolliert 1.000+ Struktur- und Redundanzpunkte, `check_workflow_contract.py` 16 Eingangsszenarien samt Eilfristen, Zeitstand, Werkstattpfaden und Ausgabe, `check_legal_anchors.py` die Rechtsprechungstabelle und `check_navigation.py` sämtliche lokalen Wege. `check_contract_builds.py` verifiziert deterministische SHA-256-Provenienz für Quellen, Buildregeln und Artefakte. Mit `BTV_VERIFY_BUILDS=1 ./scripts/validate_repo.sh` werden die drei deutschen Vertragsakten parallel außerhalb des Arbeitsbaums neu gebaut und inhaltlich verglichen.
- Rechtsprechungsanker — BGH zu Schlussrate, MaBV-Rückabwicklung, Vollstreckungsunterwerfung, Abnahme, anspruchsbegrenzter 30-Jahres-Obergrenze, DIN/Schallschutz, Regeländerungen, Geschäftsführerhaftung, Gesamt-GdWE/Untergemeinschaft und Pflichten bauträgernaher Verwalter; KG/OLG bleiben ausdrücklich gewichtete Instanzanker.
