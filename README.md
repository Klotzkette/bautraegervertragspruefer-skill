...
**30-Sekunden-Start:** (1) `SKILL.md` laden, (2) Skill und Vertrag gemeinsam in den Chat legen, (3) `Prüfe diesen Bauträgervertrag. Beginne sofort im geführten Modus; bei einer Rechnung entscheide zuerst über die Zahlungsfreigabe.` senden. Für alle drei Schreiben stattdessen ergänzen: `Vollpaket jetzt.` Eine Rollenwahl ist optional; ohne Angabe startet der Skill vorläufig für die Käuferseite und wartet nicht.
