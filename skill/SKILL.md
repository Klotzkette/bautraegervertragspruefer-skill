...
- [Gesetzgebungsstatus 2026](#gesetzgebungsstatus-2026)
...
Dieser Stichtagsblock verhindert zwei Fehler: Eine verkündete, aber noch nicht einschlägig in Kraft getretene Regel wird nicht vorzeitig angewandt; ein Entwurf wird nicht als Gesetz ausgegeben. Maßgeblich ist für jede Handlung das relevante Ereignisdatum, nicht das Datum der Beratung.
...
14. Teilungserklärung/Gemeinschaftsordnung: keine pauschalen Änderungsvollmachten; Kosten, Stimmrecht, Verwaltung, Absenkungs-/Umlaufbeschlüsse sowie bei Mehrhausanlage Gesamt-GdWE, Untergemeinschaft und individuelle Rechte sauber getrennt?
...
28. WEG-Organisation: Erstverwalter, Gesamt-GdWE/Untergemeinschaften, Anspruchsbündelung, Verwalterwarnung, Stimmrechte, Kostenverteilung, Beschlussketten, Wartungsverträge, Instandhaltungsrücklage und Übergang der Kontrolle auf Erwerber.
...
| Stimmrecht nur unklar objektbezogen oder bei Verwalterbestellung/Jahresabrechnung/Wirtschaftsplan ausgeschlossen | 🔴 | BGH V ZR 189/24: objektbezogene Beschränkung nur eindeutig; Ausschluss bei Verwalterbestellung, Jahresabrechnung oder Wirtschaftsplan nichtig |
| Kosten- oder Rechtekonflikt aus der Gemeinschaftsordnung ohne gemeinschaftsweit bindende Klärung | 🟠/🔴 | BGH V ZR 98/25: Feststellung gegen die GdWE oder Beschlussersetzung prüfen |
| Absenkungsbeschluss und nachfolgender Mehrheits-Umlaufbeschluss | 🟠/🔴 | BGH V ZR 190/25: beide Beschlüsse und beide Klagefristen getrennt prüfen; keine automatische Nichtigkeit des Sachbeschlusses |
| Pauschales Verbot von Klima-Splitgeräten auf Balkonen | 🟠/🔴 | BGH V ZR 162/25: Gestattungsanspruch nach § 20 Abs. 3 WEG grundsätzlich möglich; Installation und spätere Nutzung getrennt regeln |
...
Zusatzprüfung nach BGH V ZR 189/24 und V ZR 98/25: Stimmrechtsklauseln werden beschlussgegenstandsgenau ausgelegt. Eine eindeutig objektbezogene Beschränkung kann tragfähig sein; unauflösbare Reichweitenzweifel lassen die Beschränkung scheitern, und bei Verwalterbestellung, Jahresabrechnung oder Wirtschaftsplan ist ein gruppenbezogener Ausschluss nichtig. Bleiben konkrete Kosten- oder Mitwirkungsrechte aus der Gemeinschaftsordnung streitig, wird als Rechtsschutzziel eine Feststellung gegen die GdWE oder eine Beschlussersetzung geprüft, statt nur auf die nächste Einzelabrechnung zu warten.

Zusatzprüfung nach BGH V ZR 190/25: Bei einem Absenkungsbeschluss nach § 23 Abs. 3 Satz 2 WEG und dem darauf gestützten Sachbeschluss im Umlaufverfahren führt ein Fehler des ersten Beschlusses nicht automatisch zur Nichtigkeit des zweiten. Der Skill erfasst deshalb beide Beschlussdaten, Verkündungen, Gegenstände und Anfechtungsfristen. Wird nur der Absenkungsbeschluss angegriffen und der Sachbeschluss bestandskräftig, kann das Rechtsschutzinteresse am ersten Verfahren entfallen.

Zusatzprüfung nach BGH V ZR 162/25: Ein Verbot oder Zustimmungsvorbehalt für Klima-Splitgeräte wird nicht pauschal freigegeben oder verworfen. Zu trennen sind Anspruch auf Gestattung, Leitungsweg und Durchdringung, Aufstellort, Schwingungsentkopplung, Kondensatführung, optische Einwirkung, Wartungszugang und die erst im Betrieb zu beurteilenden Geräusche. Der Vertrag darf deshalb keine sichere spätere Genehmigungsfähigkeit versprechen; die Gemeinschaftsordnung sollte aber ein sachgerechtes Beschlussverfahren statt eines voraussetzungslosen Totalverbots vorsehen.
...
- BGH VII ZR 169/25 nicht als Sachentscheidung über die Wirksamkeit des Ratenplans und BGH XI ZR 12/25 nicht als materielle Klärung der §-7-MaBV-Bürgschaft zitieren; beide Beschlüsse behandeln die konkrete Verfahrenslage.
- Die MaBV-Novellen vom 20./28. Juli 2026 nicht als Änderung der §§ 3, 7 oder 12 MaBV ausgeben; sie betreffen andere Verwaltungs-, Weiterbildungs-, Anwendungsbereichs- und Verweisungsregeln.
- Künftige Inkrafttretensstufen des Gesetzes zur Digitalisierung des Immobilienvollzugs nicht vorziehen. Elektronische Übermittlung ersetzt weder Genehmigung noch Freistellung, notarielle Fälligkeitsmitteilung, Bautenstand oder Gegenrechtsprüfung.
- Den früheren Gebäudetyp-E-Entwurf nicht als geltendes Recht behandeln; der aktuelle § 650a BGB enthält am Stichtag keine solche Sonderregel.
...
- Stimmrechtsbeschränkungen nicht pauschal aus einem Untergemeinschafts- oder Objektbezug ableiten; nach BGH V ZR 189/24 eindeutige Reichweite verlangen und Ausschlüsse bei Verwalterbestellung, Jahresabrechnung oder Wirtschaftsplan als nichtig behandeln.
- Bei einem Absenkungsbeschluss und anschließendem Mehrheits-Umlaufbeschluss nicht auf automatische Fehlerfortwirkung vertrauen; nach BGH V ZR 190/25 beide Beschlüsse und Anfechtungsfristen getrennt prüfen.
- Ein Klima-Splitgerät weder ohne Gemeinschaftsbeschluss installieren lassen noch pauschal als unzulässig behandeln; nach BGH V ZR 162/25 Gestattung, technische Ausführung und spätere Geräusch-/Nutzungsfolgen trennen.
