...
EXACT_TRANSLATIONS = {
    ...
    "**3.4** Keine Vorleistungen. Vor der Beurkundung hat der Verkäufer keine auf den Erwerb, eine Reservierung oder Sonderwünsche entfallenden Zahlungen oder Sicherheiten entgegengenommen. Kaufpreiszahlungen und Zahlungen auf bauwerksbezogene Sonderwünsche werden ausschließlich nach Maßgabe der §§ 3.1 bis 3.3 und 3.5 angefordert.": "**3.4** No advance payments. Before notarisation, the Seller did not accept any payment or security relating to the acquisition, a reservation or special requests. Purchase Price payments and payments for construction-related special requests shall be requested only in accordance with sections 3.1 to 3.3 and 3.5.",
